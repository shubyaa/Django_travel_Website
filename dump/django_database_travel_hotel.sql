...
LOCK TABLES `travel_hotel` WRITE;
/*!40000 ALTER TABLE `travel_hotel` DISABLE KEYS */;
INSERT INTO `travel_hotel` VALUES (1,3,'Antalia',1),(2,3,'Taj Hotel',1),(3,3,'Delhi Darbar',1);
/*!40000 ALTER TABLE `travel_hotel` ENABLE KEYS */;
UNLOCK TABLES;
